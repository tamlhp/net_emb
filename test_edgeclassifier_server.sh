...
for i in "${PREFIX[@]}"
do
    python ./edge2vec/edge_classifier.py --algorithm node2vec --dataset_dir ${DATASPACE}/erdos/ --embed_dir ${DATASPACE}/erdos/emb/ \
    --prefix ${i} --func hadamard --verbose --cache ${DATASPACE}/erdos/cache-node2vec/${i}
done
