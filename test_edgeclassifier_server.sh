...
# python ./edge2vec/edge_classifier_graphsage.py --algorithm graphsage --dataset_dir ${DATASPACE}/wikipedia/graphsage --embed_dir ${DATASPACE}/wikipedia/unsup-graphsage/graphsage_mean_small_0.000010 \
...
# python ./edge2vec/edge_classifier_graphsage.py --algorithm graphsage --dataset_dir ${DATASPACE}/ca-astroph/graphsage --embed_dir ${DATASPACE}/ca-astroph/unsup-graphsage/graphsage_mean_small_0.000010 \
